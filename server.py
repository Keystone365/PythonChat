...
def NewUserAuth(client, username, passhash):
...
def OldUserAuth(client, username, passhash):
...
def acceptConnections():
    ...
    while not THREADS_JOIN:
        try:
            ...
            logger.debug("New chat member from " + addr[0] + ":" + str(addr[1]))
...
def Main():
    ...
    August 2018
    Description:
    Main function for server python chat using sockets. 
    '''
...
if __name__ == '__main__':
    ...
    #Error handling
        ...
        logger.debug('# Exception occured while in main function')
