...
def Main():
    ...
    sendMessageThread = threading.Thread(target = messageHandler, args = ()) # generate a thread to accept connections
    ...
    readMessageThread = threading.Thread(target = Chat, args = ()) # generate a thread to send all messages
